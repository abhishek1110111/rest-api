...
use frontend\models\ViewMetadata;
use common\models\CustomerLogin;
...
/***/
    ...
    public function actionViewmetadata()
    {
        $valu = new ViewMetaData();
        $message = $valu->metaInformation();
        return $this->render('viewmetadata', ['message'=>$message]);
    }
    /**
     * Logs in a user.
     *
    ...
    public function actionEntryconfirm()
    {
        {
        $model = new EntryForm();
    ...
    public function actionShowCookie()
    {
        if(yii::$app->getRequest()->getCookies()->has('hello')){
            print_r(yii::$app->getRequest()->getCookies()->getValue('hello'));
        }
    }
    ...
    public function actionMail()
    {
     ...
     ->setFrom('abhishek.kumar11101@gmail.com')
     ->setTo('abhishekkumar2020@cedcoss.com')
